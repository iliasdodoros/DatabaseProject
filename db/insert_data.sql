...
INSERT INTO elidek.Project (amount,title,beginning,ending,duration,summary,grade,date_of_grading,stelehos_id,programm_id,supervisor_id,grader_id,organisation_id) VALUES
	 (391820,'Atlantic foods','2000-01-01','2001-02-01',13,'consectetuer adipisc mauris n ultrice',3,'1999-12-01',1,1,1,80,1),
	 (143448,'American tree','2000-02-01','2001-04-01',14,'tincidunt eget tempus vel pede morbi porttitor disse',4,'2000-01-01',2,2,2,81,2),
	 (216332,'American lions','2000-03-01','2001-06-01',15,'nullam orci pede venenatis sce posuere',5,'2000-01-30',3,3,3,82,3),
	 (856065,'Octapus','2000-04-01','2001-08-01',16,'l''oreal paris',6,'2000-03-01',4,4,4,83,4),
	 (682063,'Joker Tv','2000-05-01','2001-10-01',17,'rfgrr ds  d d ',7,'2000-03-31',5,5,5,84,5),
	 (988639,'Forest ','2000-06-01','2001-12-01',18,'tempus semper est quam pharetra',8,'2000-05-01',6,6,6,85,6),
	 ...
	 (669594,'we','2000-11-01','2002-10-01',23,'imperdiet nullam orci pede venenatis non sodales sed tinciduntacus morbi sem mauris',5,'2000-10-01',1,11,11,90,11),
	 ...
	 (679829,'Ciprofeal','2001-01-01','2003-02-01',25,'non ligula pellentesque ultrices phasellus id sapien in sapien iaculis congue vivamus metus rit at vulputate',7,'2000-12-01',3,13,13,92,13),
	 (438769,'Dextrose','2001-02-01','2003-04-01',26,'dog r',8,'2001-01-01',4,14,14,93,14),
	 (905398,'Doghouse','2001-03-01','2003-06-01',27,'et tempus semper est quam pharetra magna ac consequat metus sapien ut nunc vestibulum ante',9,'2001-01-29',5,15,15,94,15),
	 ...
	 (152025,'Details','2001-06-01','2003-12-01',30,'suscipit ligula in lacus curabitur at ipsum ac tellus semper orper',4,'2001-05-01',8,18,18,97,18),
	 ...
	 (589991,'Lamperos','2001-08-01','2004-04-01',32,'Antropos',6,'2001-07-01',10,20,20,99,20),
	 ...
	 (433644,'John Snow','2002-03-01','2005-06-01',39,'dssvcsdv dfv dSa',5,'2002-01-29',7,27,27,6,27),
	 ...
	 (460197,'Food','2020-01-01','2021-01-01',12,'bibendum morbi non  rutrum nulla tellus in',9,'2019-12-01',1,1,31,10,1),
	 ...
	 (123433,'Lagoon,','2020-09-01','2022-05-01',20,'restart',9,'2020-08-01',9,9,39,18,9),
	 ...
	 (499193,'METH','2020-12-01','2022-11-01',23,'ma an prepei tha tous pao sthn meth',4,'2020-10-31',2,12,42,21,12),
	 ...
	 (546606,'tree','2021-04-01','2023-07-01',27,'leo pellentesque ultrices mattis odio donec vitae nisi nam ultrices libero non mattis pulvina augue',8,'2021-03-01',6,16,46,25,16),
	 ...
	 (595821,'prep ','2021-10-01','2024-07-01',33,'nulla integer pede justo lacinia r loremconsequat',6,'2021-08-31',2,22,52,31,22),
	 ...
	 (470555,'Red dragon','2022-04-01','2025-07-01',39,'root ',4,'2022-03-01',8,28,58,37,28),
	 ...
	 (309511,'Clown','2022-07-01','2026-01-01',42,'thedorop',7,'2022-05-31',1,1,61,40,1),
	 ...
	 (148630,'reset','2022-09-01','2026-05-01',44,'vestibulum eget ',9,'2022-08-01',3,3,63,42,3),
	 ...
	 (444879,'Two-two','2023-04-01','2027-04-01',48,'pulvinar nulla ped',8,'2023-03-01',10,10,70,49,10),
	 ...
	 (601962,'WHITE man','2023-07-01','2027-07-01',48,'quis orci nullam molestie nibh in lectus pellentesque at  magna',3,'2023-05-31',3,13,73,52,13),
